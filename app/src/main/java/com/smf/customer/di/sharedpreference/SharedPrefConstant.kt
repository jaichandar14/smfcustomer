...
object SharedPrefConstant {
    ...
    val EVENT_SERVICE_STATUS: String
        get() = "eventServiceStatus"
    ...
    val SERVICE_QUESTIONS_RES_DTO: String
        get() = "eventQuestionsResponseDTO"
}